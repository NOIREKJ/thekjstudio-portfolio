  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        name: "Name", contact: "Email or phone",
        submit: "Send", sending: "Sending…",
        ok: "Got it — I'll be in touch soon.",
        err: "Something went wrong. Please try again.",
        note: "Anything else",
        notePlaceholderCommission: "e.g. the mood you're after, a reference track, must-haves…",
        notePlaceholderLesson: "e.g. a song you'd love to play, your goal, days that work…",
        notePlaceholderOther: "Write your message",
        services: "What do you need", serviceOptions: ["Composing", "Arranging", "Mixing/Mastering", "Session keys", "Other"],
        usage: "Where it's for", usagePlaceholder: "e.g. YouTube video, album track, worship, ad",
        reference: "Mood / reference", referencePlaceholder: "A reference track or the feel you want",
        timeline: "Timeline", timelinePlaceholder: "e.g. within 2 weeks / no rush",
        subject: "What to learn", subjectOptions: ["Piano", "Composition", "Both", "Not sure yet"],
        level: "Your level", levelOptions: ["Total beginner", "Played a little", "Hobby player"],
        goal: "Why / your goal", goalPlaceholder: "e.g. play songs I love / write my own music",
        when: "Area / time", whenPlaceholder: "e.g. Seoul, weekday evenings",
      },
    },
    about: {
  ...
  ko: {
    ...
    contact: {
      ...
      form: {
        ...
        name: "이름", contact: "이메일 또는 전화",
        submit: "보내기", sending: "보내는 중…",
        ok: "문의가 접수됐습니다. 곧 연락드릴게요.",
        err: "전송에 문제가 생겼습니다. 다시 시도해주세요.",
        note: "추가로 하고 싶은 말",
        notePlaceholderCommission: "예: 원하는 분위기, 참고 곡, 꼭 넣고 싶은 것…",
        notePlaceholderLesson: "예: 배우고 싶은 곡, 목표, 가능한 요일…",
        notePlaceholderOther: "내용을 적어주세요",
        services: "필요한 작업", serviceOptions: ["작곡", "편곡", "믹싱·마스터링", "세션 건반", "기타"],
        usage: "어디에 쓰나요", usagePlaceholder: "예: 유튜브 영상, 앨범 수록곡, 예배, 광고",
        reference: "분위기·레퍼런스", referencePlaceholder: "참고 곡이나 원하는 느낌",
        timeline: "희망 일정", timelinePlaceholder: "예: 2주 내 / 급하지 않아요",
        subject: "무엇을 배우고 싶나요", subjectOptions: ["피아노", "작곡", "둘 다", "아직 모르겠어요"],
        level: "지금 수준", levelOptions: ["완전 처음", "조금 쳐봤어요", "취미로 치는 중"],
        goal: "배우고 싶은 이유·목표", goalPlaceholder: "예: 좋아하는 곡을 치고 싶어요 / 내 곡을 만들어보고 싶어요",
        when: "희망 지역·시간대", whenPlaceholder: "예: 서울 OO구, 평일 저녁",
      },
    },
    about: {
